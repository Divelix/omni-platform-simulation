...
class CarSim:
    ...
    def __init__(self, client_id, car_name, wheel_names, w, l, r):
        ...
        self.omni_tl = WheelSim(client_id, omni_tl_handle, r)
        self.omni_tr = WheelSim(client_id, omni_tr_handle, r)
        self.omni_br = WheelSim(client_id, omni_br_handle, r)
        self.omni_bl = WheelSim(client_id, omni_bl_handle, r)
